...
$sql = "SELECT tblleaves.id as lid,tblinterns.FirstName,tblinterns.LastName,tblinterns.IntCode,tblinterns.id,tblinterns.Gender,tblinterns.Phonenumber,tblinterns.Email,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblinterns on tblleaves.intId=tblinterns.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Employe Name :</b></td>
                                              ...
                                              <td style="font-size:16px;"><b>Intern Id :</b></td>
                                              <td><?php echo htmlentities($result->IntCode);?></td>
                                              <td style="font-size:16px;"><b>Gender :</b></td>
                                              <td><?php echo htmlentities($result->Gender);?></td>
                                          </tr>

                                          <tr>
                                             <td style="font-size:16px;"><b>Intern Email id :</b></td>
                                            <td><?php echo htmlentities($result->Email);?></td>
                                             <td style="font-size:16px;"><b>Intern Contact No. :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Intern Leave Description : </b></td>
...
<?php } ?>
					   ...
					   &nbsp;&nbsp;&nbsp;<a class="btn btn-primary" href="#" role="button"> Download PDF</a>
                </div>
            </main>
