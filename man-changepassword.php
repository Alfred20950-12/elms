...
$username=$_SESSION['emplogin'];
    $sql ="SELECT Password FROM tblmanagement WHERE Email=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblmanagement set Password=:newpassword where Email=:username";
