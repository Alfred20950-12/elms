...
$sql="INSERT INTO tblleaves(Firstname, Lastname,LeaveType,ToDate,FromDate,Description,Status,IsRead,empid) VALUES(:firstname,:lastname,:leavetype,:todate,:fromdate,:description,:status,:isread,:empid)";
...
<label for="fromdate">First Name</label>
<input placeholder="" id="mask1" name="firstname" class="masked" type="text"  required>
</div>
<div class="input-field col m6 s12">
<label for="fromdate">Last Name</label>
<input placeholder="" id="mask1" name="lastname" class="masked" type="text"  required>
</div>
