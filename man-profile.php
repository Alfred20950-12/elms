...
$sql="update tblmanagement set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
...
<?php 
$eid=$_SESSION['emplogin'];
$sql = "SELECT * from  tblmanagement where Email=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
<label for="empcode">Manager Code</label>
