...
$username=$_SESSION['emplogin'];
    $sql ="SELECT Password FROM tblinterns WHERE Email=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblinterns set Password=:newpassword where Email=:username";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Intern | Change Password</title>
