...
$sql="INSERT INTO tblinterns(IntCode,FirstName,LastName,Email,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(:IntCode,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':IntCode',$IntCode,PDO::PARAM_STR);
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add Intern</div>
                    </div>
...
<label for="intCode">Intern Code(Must be unique)</label>
<input  name="IntCode" id="IntCode" onBlur="checkAvailabilityIntCode()" type="text" autocomplete="off" required>
<span id="IntCode-availability" style="font-size:12px;"></span> 
</div>
