...
$sql="INSERT INTO tblmanagement(ManCode,FirstName,LastName,Email,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(:ManCode,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':ManCode',$ManCode,PDO::PARAM_STR);
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add Management</div>
                    </div>
...
<label for="manCode">Manager Code(Must be unique)</label>
<input  name="ManCode" id="ManCode" onBlur="checkAvailabilityManCode()" type="text" autocomplete="off" required>
<span id="ManCode-availability" style="font-size:12px;"></span> 
</div>
...
<input  name="email" type="email" id="email" onBlur="checkAvailabilityEmail()" autocomplete="off" required>
